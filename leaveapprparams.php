...
<form  action="leaveappr.php"  method="GET" name="leaveapprfrm" onsubmit="return v.exec()" >
<tr>
...
<!-- // create calendar object(s) just after form tag closed
 ...
 var cal1 = new calendar1(document.forms['leaveapprfrm'].elements['date1']);
 cal1.year_scroll = true;
 cal1.time_comp = false;
 var cal2 = new calendar1(document.forms['leaveapprfrm'].elements['date2']);
