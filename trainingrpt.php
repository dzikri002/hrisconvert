...
<head>
	...
	<title>Staff Training Report </title>
...
<? 
  ...
  $d->connect($db_host, $db_user, $db_pass, $db); 
   ...
   if (!empty($_GET["id"]))
    ...
    $sqlstr="select tbl_training.*,LastName,OtherNames,trainingsdate,designation.designation,tbl_qlevels.qlevel,prdept.DeptName from tbl_training 
    inner join prmember on prmember.MemberNo=tbl_training.employeeid left join prdept on prdept.deptcode=prmember.dept
    left join designation on prmember.position_fk=designation.id left join tbl_qlevels on tbl_qlevels.id=compechieved order by MemberNo,DeptName";		  
...
<form name="totalsrepfrm" method="post" action="trainingrpt.php">
    ...
    <td  bgcolor="#FFFFFF" ><table width="100%"  border="0">
      <tr>
		...
		<th width="5%"><div align="center">Designation</div></th>
		 <th width="5%"><div align="center">Competency Achieved</div></th>
		 <th width="5%"><div align="center">Start Date</div></th>
		<th width="5%"><div align="center">Completion Date</div></th>
