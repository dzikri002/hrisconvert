...
.header2, h2
		{color: #000000; background: #DBEAF5; font-weight: regular; font-family: Tahoma, Verdana; font-size: 10px;}
.btnform
...
<form  action="leaveidv.php"  method="GET" name="leaveidvfrm" onsubmit="return v.exec()" >
<tr>
...
<!-- // create calendar object(s) just after form tag closed
 ...
 var cal1 = new calendar1(document.forms['leaveidvfrm'].elements['date1']);
 cal1.year_scroll = true;
 cal1.time_comp = false;
 var cal2 = new calendar1(document.forms['leaveidvfrm'].elements['date2']);
...
var v = new validator('leaveidvfrm', a_fields, o_config);
