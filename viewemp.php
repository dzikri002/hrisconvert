...
<table width="100%"  border="0">
  ...
  <tr>
    <td><? if (!empty($id))  echo "<center><img src='viewimg.php?imgid=$id' width=170 Height=170 ></center>"; ?>
&nbsp;    </td>
  </tr>
  <tr>
    <td><? if (!empty($row->FullName)) echo "<b>Full Name : </b>".$row->title." ".$row->FullName; 
  ...
  <tr>
    <td>&nbsp;<? if (!empty($row->designation)) echo "<br><b>Designation :</b>".$row->designation; ?></td></tr>
	<tr><td>&nbsp;<? if (!empty($row->DeptName)) echo "<br><b>DeptName :</b>".$row->DeptName; ?></td></tr>
  </tr>
</table>
<?
  $d->close();
