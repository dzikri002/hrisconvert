...
<? 
  ...
  $dispmsg = "<font face = Verdana size=4><strong>Staff Dependants Report</strong></font>";
   if (!empty($_GET["id"]))
    ...
    $sqlstr="select * from hrusers order by id";		  
...
<table width="847" cellpadding="0" cellspacing="0"  id="main">
  ...
  <tr>
    <td >
    &bull;&nbsp;<a href="index.php" onfocus="blurLink(this);">Home</a>&nbsp;&bull;&nbsp; <a href="adduser.php" onfocus="blurLink(this)">Add User</a> &nbsp;</td>
  ...
  <tr>
    <td  bgcolor="#FFFFFF" ><table width="100%"  border="0">
      <tr>
		...
		<th width="5%"><div align="center">Set</div></th>
		</tr>
	  <?
		 ...
		 //count active staff for now	
		  ...
		  while ($row=$d->fetch_object($result))
		  {
		    ...
		    echo "<td><a href=\"javascript:setperms($row->id)\"> Set </a></td>";
		  }
...
<script language="JavaScript">
 function setperms(userid)
	 {
        var url = "setperms.php?userid="+userid;
   
        newwin = window.open(url,'Add','width=350,height=400,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=2,resizable=0');
        newwin.focus();
     }
</script>
</body>
