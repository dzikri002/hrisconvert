...
<? 
  ...
  $dispmsg = "<font face = Verdana size=4><strong>Staff Dependants Report</strong></font>";
   if (!empty($_GET["id"]))
    ...
    $sqlstr="select tbl_dependants1.*,LastName,OtherNames,round((datediff(now(),dob)/365),0) as age from tbl_dependants1 left join prmember on prmember.MemberNo=tbl_dependants1.empid_fk order by MemberNo";		  
...
<form name="totalsrepfrm" method="post" action="dependantsrpt.php">
  ...
  <tr>
    <td  bgcolor="#FFFFFF" ><table width="100%"  border="0">
      <tr>
		...
		<th width="5%"><div align="center">Dependant Name </div></th>
