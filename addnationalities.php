...
-->
 ...
 function validateOnSubmit() {
    ...
    if (!validatePresent(document.forms.addnationalitiesfrm.country,'inf_country')) errs += 1; 
...
<? 
  ...
  {
    $id=$_GET["countryid"];
    $sqlstr="select * from tbl_countries1 where id=$id";
  ...
  { 
   ...
   if (!empty($action) && ($action=="edit"))
     $query="update tbl_countries1 set countryname=$country  where id=$id";
   else
     $query="insert into tbl_countries1 (countryname) values ($country)";
  ...
  // echo $query;
   ...
   if (!empty($query))
   {
	...
	else
	{
	   ...
	   echo "<meta http-equiv='refresh' content='1;url=addnationalities.php'>";
	}
   }
...
<form name="addnationalitiesfrm" method="post" action="addnationalities.php">
<table width="100%"  border="0">
      <tr>
        <th width="20%"><div align="right">Country</div></th>
        <th>          
        <input name="country" type="text" id="country" size="60"  <? if (!empty($country)) echo "value='$country'"; ?>>
          <div class="highlight" id="inf_country">&nbsp;</div>
        </th></tr>
      <tr>
        <th>
  ...
  <tr>
    <td  bgcolor="#FFFFFF" ><table width="100%"  border="0">
	  ...
	  <?
	      ...
	      $sqlstr="select * from tbl_countries1";
		  ...
		  while ($row=$d->fetch_object($result))
		  {
		    ...
		    echo "<td> <a href=addnationalities.php?countryid=$row->id&action=edit>Edit</a></td>";
		    echo "</tr></td>";
		  }
