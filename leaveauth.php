   ...
   echo "</fieldset>";
	...
	if (!empty($_GET["date2"]))
    {
	  ...
	  $sqlstr="Select  intranet_leave.id,intranet_leave.dateto, intranet_leave.numdays,  intranet_leave.pnumber,
       ...
       intranet_leave.datefrom,  intranet_leave.approved, intranet_leave.authorised, intranet_leave.authorisedby,
       intranet_leave.authorised, intranet_leave.dateauthorised, intranet_desig.DESIGNAME, intranet_depts.deptname
       From
       intranet_leave
       ...
       where addedby='$user' and (authorised=1) and (dateapplied >= '$lastwk' and dateapplied <= '$today')";
	}
	else
	{
        ...
        <td bgcolor=\"#DBEAF5\"><table cellspacing=\"1\" cellpadding=\"3\" border=\"0\" width=\"100%\">
            <tbody>
              <tr bgcolor=\"#ffffff\">
				...
				<td width=\"12%\" class=\"header9\"><div align=\"right\"><b>Authorised By </b></div></td>
				<td width=\"12%\" class=\"header9\"><div align=\"right\"><b>Date Authorised </b></div></td>
 ...
 while ($row=mysql_fetch_object($data))
 {
	...
	echo "<tbody>
              <tr bgcolor=\"#ffffff\">
				...
				<td width=\"12%\" ><div align=\"right\">$row->authorisedby </div></td>
				<td width=\"12%\" ><div align=\"right\">$row->dateauthorised</div></td>";
