...
<head>
	...
	<title>Totals by Designations </title>
...
<? 
  ...
  $d->connect($db_host, $db_user, $db_pass, $db); 
   ...
   if (!empty($_POST["datefrom"]) && !empty($_POST["dateto"]))
   {
	  ...
	  $sqlstr="select count(*) as totals,designation.designation,designation.id as posid from prmember 
      inner join designation on designation.id=prmember.position_fk where empstatus_fk =1 and empdate >= '$datefrom' and empdate <= '$dateto' group by designation";
	}
	else
	  $sqlstr="select count(*) as totals,designation.designation,designation.id as posid from prmember inner join designation on designation.id=prmember.position_fk where empstatus_fk =1 group by designation";
...
<form name="totalsrepfrm" method="post" action="totalsdesigrep.php">
    ...
    <td  bgcolor="#FFFFFF" ><table width="100%"  border="0">
	  ...
	  <?
		 ...
		 //count active staff for now	
		  ...
		  {
		    echo "<tr>";
			echo "<td><a href=\"totalsdesigrepdet.php?desigid=$row->posid\">".$row->designation."</a></td>";
